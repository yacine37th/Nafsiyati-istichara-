...
import '../controller/istichara.dart';
...
class Istichara extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    IsticharaController isticharaController = Get.find();
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
            onPressed: () {
        ...
        child: Column(
          ...
          children: [
            ...
            ListView.builder(
              ...
              itemCount: isticharaController.activities.length,
              itemBuilder: (context, index) {
                final activity = isticharaController.activities[index];
                return Column(
                  children: [
                    CustomButton(
                        onPress: () {
